...
public class EvolutionManager : MonoBehaviour
{
    ...
    {
        return false;//geneticAlgorithm.GenerationCount >= RestartAfter;
    }
    ...
    private void StartEvaluation(IEnumerable<Genotype> currentPopulation)
    {
        ...
        foreach (Genotype genotype in currentPopulation)
        {
            agents.Add(new Agent(genotype, MathsUtils.SoftSignFunction, FNNTopology));
            //float[] temp = genotype.GetParameterCopy();
            //string s = "";
