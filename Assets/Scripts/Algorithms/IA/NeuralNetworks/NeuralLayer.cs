...
namespace ThomasBisson.Algorithms.IA
{
    ...
    public class NeuralLayer
    {
        ...
        public ActivationFunction NeuronActivationFunction = MathsUtils.SigmoidFunction;
        ...
        public double[] ProcessInputs(double[] inputs)
        {
            ...
            //Add 1 to the end of the array (don't know why)
        ...
        public override string ToString()
        {
            ...
            for (int x = 0; x < Weights.GetLength(0); x++)
            {
                for (int y = 0; y < Weights.GetLength(1); y++)
                    output += String.Format("{0, " + Math.Abs(y - 10) * 2 + "}", "[" + x + "," + y + "]: " + Weights[x, y] + ", ");
